...
<script type="text/javascript" src="http://ihcd.qiniudn.com/jquery.js"></script>
<script>
function changetoen(){
...
<div id="main"  style="display:none">
  ...
  <!-- zh -->
    ...
    <div id="content">
      ...
      <p>服务器无法正常提供信息。<br>
      目标页面可能已经被更改、删除或移到其他位置，或您所输入页面地址错误。<br>您请求的页面: '.$_SERVER[REQUEST_URI].'</p>
      <div class="utilities">
        <form>
          <div class="input-container">
        ...
        <a class="button right" href="#" onClick="history.go(-1);return true;">返回上一页...</a><a class="button right" href="../../../../../">返回首页</a>
        <div class="clear"></div>
      </div>
    </div>
    <div id="footer">
